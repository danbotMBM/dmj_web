...
const flapSound = new Audio("https://freesound.org/data/previews/400/400331_5121236-lq.mp3");
const pointSound = new Audio("https://freesound.org/data/previews/341/341695_3248244-lq.mp3");
...
function update() {
    ...
    dragons.forEach(dragon => {
        dragon.x -= 2; // parallax like pipes
    });
...
function draw() {
    ...
    // Draw dragons (and position the gif)
    if (dragons.length > 0) {
        const d = dragons[0];
