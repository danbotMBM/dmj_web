...
function draw() {
    ...
    if (!gameStarted) {
        ctx.fillStyle = "black";
        ctx.font = "30px Arial";
        ctx.fillText("Press Space or Start", canvas.width / 4 - 20, canvas.height / 2);
        return;
    }
    ...
    if (gameOver) {
        ...
        ctx.font = "20px Arial";
        ctx.fillText("Press Space or Restart", canvas.width / 4 - 10, canvas.height / 2 + 40);
    }
}
